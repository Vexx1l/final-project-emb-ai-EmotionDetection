...
Este es el proyecto final del curso "Desarrollo de aplicaciones de IA con Python y Flask" del Certificado de Desarrollador de Software Full Stack de IBM. El objetivo de este proyecto es desarrollar una aplicación web Flask basada en IA que permita al usuario introducir una cadena de texto y recibir una respuesta de la IA que le indique la emoción que transmite dicho texto.
